from src.classes.file_type import fileType
from src.modules.extract_info_video import extractInfoVideo
...
from src.modules.database import read_db
from src.modules.compress import split, getBytes
